...
import pmMockup from "@/assets/CTA_Dual_Image.png";
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
             ...
             <div className="flex flex-col justify-center">
               <motion.h2
                 ...
                 className="text-3xl md:text-4xl lg:text-5xl font-heading text-white leading-tight max-w-xl"
               >
               ...
               <motion.p
                 ...
                 className="text-white/65 text-base mt-6 max-w-md"
               >
               ...
               <motion.div
                 ...
                 whileTap={{ scale: 0.98 }}
                 className="mt-8 inline-block self-start"
               >
                 <a
                   href="/sign-up"
                   className="group flex items-center gap-1 bg-[#09f] hover:bg-[#0088dd] text-white px-8 py-3.5 rounded-full text-base transition-colors cursor-pointer"
                 >
