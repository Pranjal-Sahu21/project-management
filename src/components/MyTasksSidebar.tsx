                    ...
                    <div className="space-y-1">
                        {myTasks.length === 0 ? (
                            ...
                            myTasks.map((task, index) => (
                                <Link key={index} href={`/taskDetails?projectId=${task.projectId}&taskId=${task.id}`} className="w-full block rounded-lg transition-all duration-200 text-gray-700 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-800 hover:text-black dark:hover:text-white" >
