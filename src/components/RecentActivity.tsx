...
const RecentActivity = () => {
    ...
    const getTasksFromCurrentWorkspace = () => {
        ...
        const allTasks = currentWorkspace.projects.flatMap((project: any) => project.tasks.map((task: any) => task));
        setTasks(allTasks);
    };
                                            ...
                                            <div className="flex items-center gap-3 text-xs text-zinc-500 dark:text-zinc-400">
                                                ...
                                                {task.assignee && (
                                                    <div className="flex items-center gap-1">
                                                        <div className="w-4 h-4 bg-zinc-300 dark:bg-zinc-700 rounded-full flex items-center justify-center text-[10px] text-zinc-800 dark:text-zinc-200 font-semibold">
