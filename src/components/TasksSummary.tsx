                    ...
                    <div className="p-4">
                        {card.items.length === 0 ? (
                            ...
                            <div className="space-y-3">
                                ...
                                {card.count > 3 && (
                                    <button className="flex items-center justify-center w-full text-sm text-gray-500 dark:text-zinc-400 hover:text-gray-800 dark:hover:text-white mt-2 cursor-pointer">
